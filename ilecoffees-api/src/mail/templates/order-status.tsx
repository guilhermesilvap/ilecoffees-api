...
export function OrderStatusEmail({ recipient, payload }: Props) {
        ...
        <Container style={{ maxWidth: 480, margin: '40px auto', background: '#ffffff', borderRadius: 8, overflow: 'hidden' }}>
          ...
          <Section style={{ padding: '32px' }}>
            <Heading style={{ fontSize: 22, color: '#1a1a1a', marginTop: 0 }}>
              Atualização do pedido {label && `— ${label}`}
            </Heading>
            ...
            <Text style={{ color: '#888', fontSize: 12, margin: 0 }}>
              Você recebeu este e-mail porque possui um pedido ativo na ilecoffees.
            </Text>
          </Section>
        </Container>
      </Body>
