...
export function SubscriptionActivatedEmail({ recipient, payload }: Props) {
  return (
    <Html lang="pt-BR">
      <Head />
      <Body style={{ fontFamily: 'sans-serif', background: '#f5f5f5', margin: 0 }}>
        <Container style={{ maxWidth: 480, margin: '40px auto', background: '#ffffff', borderRadius: 8, overflow: 'hidden' }}>
          ...
          <Section style={{ padding: '32px' }}>
            ...
            <Button
              href="https://ilecoffees.com.br/dashboard/customer"
              style={{
                background: '#3d2314',
                color: '#ffffff',
                padding: '12px 24px',
            ...
            <Text style={{ color: '#888', fontSize: 12, margin: 0 }}>
              Você recebeu este e-mail porque ativou uma assinatura na ilecoffees.
            </Text>
          </Section>
        </Container>
      </Body>
